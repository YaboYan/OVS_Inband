...
struct dpif_class {
    ...
    void (*dpif_netlink_ofbuf_send)(struct ofpbuf *ofbuff_trans, struct dpif *dpif_ ,unsigned int src_ip,
    		unsigned int dst_ip,  ovs_be16 portid,struct eth_addr src_ea,struct eth_addr dst_ea,const char *br_name);
     ...
     * is stored in '*dpifp'. */
    int (*open_ex)(const struct dpif_class *dpif_class, const char *name,
            bool create, struct dpif **dpifp, __be32  ipv4 );
    int (*open)(const struct dpif_class *dpif_class, const char *name,
    ...
    int (*port_add)(struct dpif *dpif, struct netdev *netdev,
                    odp_port_t *port_no,__be32  ipv4);
