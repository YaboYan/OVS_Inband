...
int dpif_open_ex(const char *name, const char *type, struct dpif **, __be32  ipv4);
int dpif_create_ex(const char *name, const char *type, struct dpif **, __be32  ipv4);
int dpif_create(const char *name, const char *type, struct dpif **);
int dpif_create_and_open(const char *name, const char *type, struct dpif **, __be32  ipv4);
...
int dpif_port_add(struct dpif *, struct netdev *, odp_port_t *port_nop,__be32  ipv4);
