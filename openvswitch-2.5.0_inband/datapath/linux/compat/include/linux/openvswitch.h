...
/* openflow buffs */
#define OVS_OFBUF_FAMILY "ovs_ofbuf"
#define OVS_OFBUF_VERSION 0x1

enum ovs_ofbuf_cmd {
	OVS_OFBUF_CMD_UNSPEC,
	OVS_OFBUF_SEND
};
enum ovs_ofbuff_attr {
	OVS_OFBUFF_ATTR_UNSPEC,
	OVS_OFBUFF_ATTR_SRC_IP,
	OVS_OFBUFF_ATTR_DST_IP,
	OVS_OFBUFF_ATTR_PORTID,
	OVS_OFBUFF_ATTR_SRC_EA,
	OVS_OFBUFF_ATTR_DST_EA,
	OVS_OFBUFF_ATTR_BR_NAME,
	OVS_OFBUFF_ATTR_DATA,
	__OVS_OFBUFF_ATTR_MAX
};

#define OVS_OFBUFF_ATTR_MAX (__OVS_OFBUFF_ATTR_MAX - 1)
