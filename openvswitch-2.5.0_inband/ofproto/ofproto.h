...
void handle_openflow(struct ofconn *ofconn, const struct ofpbuf *ofp_msg)
...
void ofproto_set_controllers(struct ofproto *p, struct ofproto *p_main, struct eth_addr ea,struct eth_addr ea_main,
        const struct ofproto_controller *controllers,
        size_t n_controllers, uint32_t allowed_versions);
void ofproto_set_controllers_main(struct ofproto *p,
                        const struct ofproto_controller *controllers,
                        size_t n_controllers, uint32_t allowed_versions);
